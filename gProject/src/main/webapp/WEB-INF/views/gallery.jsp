...
<div class="page-wrap">
	...
	<nav id="nav">
        ...
        <!-- Header -->
        <header id="header">
	        <div>Snapshot <span>by TEMPLATED</span>
	        </div>
        </header>
		...
		<h1>Gallery</h1>
		    <ul class="tabs">
			    <li>
			    	<a href="#" class="button active" onclick="location.href='photoUpload'">upload</a>
			    </li>
		        <li>
		        	<a href="#" data-tag="people" class="button">taipei</a>
		        </li>
		        <li>
		        	<a href="#" data-tag="place" class="button">vladivostok</a>
		        </li>
		        <li>
		        	<a href="#" data-tag="thing" class="button">osaka</a>
		        </li>
		    </ul>
	    </header>
			<div class="content">
